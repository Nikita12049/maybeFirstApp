namespace domashka
{
    internal class LinesAndConditions
    {
        ...
        public static string CheckingTheGoods(double length, double width, double height, double weight, double distance)
        {
            ...
            {
                answer = "Ваш заказ НЕ малогабаритный";
            }
            ...
            {
                answer = "Ваш заказ малогабаритный";
            }
